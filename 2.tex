...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{{plots/strategies/dominance_gap_first_visits_area_screen_loc_h.png}}
    \label{fig:sl_h}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{{plots/strategies/dominance_gap_first_visits_area_screen_loc_g.png}}
    \label{fig:sl_h}
\end{figure}
